 ...
 *
 * @delims: Pnter TO null terminated array OF delimitors.
 *
...
/**
 * get_word_count - gets the WORD count of a Strng.
 *
 ...
 *
 * @str: Strng TO get NEXT word from.
 * @delims: Delimitors TO use TO Delimit Words
 *
 * Return: Pnter TO FRst charACTER of Next word
 */
